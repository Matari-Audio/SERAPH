...
use super::auth::{
    dispatch_cancel_login, dispatch_login, dispatch_login_with_method, dispatch_logout,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::LoginWithMethod(method_id) => dispatch_login_with_method(app, method_id),
